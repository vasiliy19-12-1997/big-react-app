...
describe('profileSlice.test', () => {
    ...
    test('test updateProfile ', () => {
        ...
        expect(profileReducers(state as ProfileSchema, profileActions.updateProfile({ username: '123' }))).toEqual({
            form: { username: '123' },
        });
    });
    ...
    test('test updateProfile pending', () => {
        ...
        expect(profileReducers(state as ProfileSchema, updateProfileData.pending)).toEqual({
            isLoading: true,
            validateErrors: undefined,
        });
    });
    test('test updateProfile fulfilled ', () => {
        ...
        expect(profileReducers(state as ProfileSchema, updateProfileData.fulfilled(data, ''))).toEqual({
            isLoading: false,
            validateErrors: undefined,
            readonly: true,
            data,
